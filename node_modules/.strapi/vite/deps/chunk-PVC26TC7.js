...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-SGGLMAZT.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-HBXRJTEU.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-3EX3CUNZ.js");
...
//# sourceMappingURL=chunk-PVC26TC7.js.map

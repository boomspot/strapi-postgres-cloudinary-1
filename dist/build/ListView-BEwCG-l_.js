import{j as e,k as b,Z as p,eW as O,a as I,e as x,T as k,h as ye,r as R,aI as L,I as N,f as je,a5 as Ce,fV as we,bU as Y,b6 as z,a2 as K,fW as Te,g as Q,bA as $e,bH as ve,bI as ke,cR as De,bl as Me,b as ee,aF as Re,q as Fe,bJ as te,C as B,d3 as Ae,U as Ie,y as Se,fe as Ee,bn as Le,aO as J,fX as Oe,A as ne}from"./strapi-D6_8LALh.js";import{u as D,g as m,C as X,a as V,A as Ue,S as Ne,c as _}from"./index-WDekYiSH.js";import{d as Be,e as Pe,D as We,f as Ze,a as ze,S as Ve,v as He,P as qe,c as Ge,C as Je}from"./sortable.esm-9JH3EfB0.js";import"./groupBy-CunoluPG.js";import"./_baseEach-DwO-HgRh.js";import"./sortBy-omryRPok.js";import"./_baseMap-DtAdlV3I.js";import"./index-CgobJhiP.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";const Xe=t=>{let{transform:n}=t;return{...n,x:0}},_e=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,ie=({component:t,isFromDynamicZone:n=!1,firstLoopComponentUid:o})=>{const{components:s}=D(),l=O(s,t);return e.jsx(oe,{$isChildOfDynamicZone:n,className:"component-row",children:e.jsx(de,{type:l,firstLoopComponentUid:o||t,isFromDynamicZone:n,isSub:!0,secondLoopComponentUid:o?t:null})})},et=({type:t,customField:n=null,repeatable:o=!1,multiple:s=!1})=>{const{formatMessage:l}=I();let a=t;return["integer","biginteger","float","decimal"].includes(t)?a="number":["string"].includes(t)&&(a="text"),n?l({id:m("attribute.customField"),defaultMessage:"Custom field"}):e.jsxs(e.Fragment,{children:[o&&l({id:m("component.repeatable"),defaultMessage:"Repeatable"}),s&&l({id:m("media.multiple"),defaultMessage:"Multiple"})," ",l({id:m(`attribute.${a}`),defaultMessage:t})]})},tt=({isActive:t=!1,icon:n="dashboard"})=>{const o=X[n]||X.dashboard;return e.jsx(x,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:e.jsx(o,{height:"2rem",width:"2rem"})})},se=b(p)`
  position: absolute;
  display: none;
  top: 5px;
  right: 0.8rem;
...
`,ut=({uid:t})=>{const{components:n}=D(),o=O(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(Y,{onClick:s=>s.stopPropagation(),tag:K,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:z(o.info.displayName)}),")"]})},ae=b(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
